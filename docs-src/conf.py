...
source_dir = os.path.join(os.path.dirname(__file__), '..', '{ my-simulator }')
...
html_theme_options = {
    'github_user': '{ owner-of-source-code-repo-for-my-simulator }',
    'github_repo': '{ source-code-repo-for-my-simulator }',
    'github_banner': True,
    'github_button': True,
    'description': 'BioSimulators-compliant interface to { my-simulator }',
    'fixed_sidebar': True,
